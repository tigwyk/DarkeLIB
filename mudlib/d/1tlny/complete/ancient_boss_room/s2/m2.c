...
switch(random(14)){
  ...
  set("chase",1);
   ...
   set_stats("strength", 200 + random(30));
   set_stats("dexterity", 200 + random(30));
   set_stats("constitution", 200 + random(20));
   ...
   set_skill("defense", 180);
   set_skill("dodge", 180);
   set_skill("reverse stroke", 180);
   set_skill("martial arts",180);
   set_skill("concentrate", 180);
