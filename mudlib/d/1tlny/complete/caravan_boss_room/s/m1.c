...
create() {
  ::create();
   ...
   set_stats("strength", 110 + random(30));
   set_stats("dexterity", 110 + random(30));
   set_stats("constitution", 110 + random(20));
