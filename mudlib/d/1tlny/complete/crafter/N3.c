...
void create() {
  ...
  set("long", "This is a room that you can train global skills for armour for all players. You need to join a guild to train skills for a specific guild to learn attack skills or spells.\n");
