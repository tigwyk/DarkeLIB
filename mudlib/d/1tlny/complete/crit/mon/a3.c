...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "lesser elemental", "earth elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(5);
  set_overall_ac(5);
  set_short("lesser earth elemental");
  set_long("This lesser elemental glows with the energy of earth");
  set_aggr_status(0);

	set_melee_damage( (["impact" : 5 , "crushing" : 5 ]) );
