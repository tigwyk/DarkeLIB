...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "lesser elemental", "fire elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_long("This lesser elemental glows with the energy of fire");
  set_aggr_status(0);

	set_melee_damage( (["fire" : 5, "stress" : 5 ]) );
