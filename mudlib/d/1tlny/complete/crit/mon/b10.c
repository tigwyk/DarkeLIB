...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "minor elemental", "plasma elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(10);
  set_overall_ac(10);
  set_short("minor plasma elemental");
  set_long("This minor elemental glows with the energy of plasma");
  set_aggr_status(0);

	set_melee_damage( ([ "plasma" : 10, "fire" : 10, "electricity"  : 10 ]) );
