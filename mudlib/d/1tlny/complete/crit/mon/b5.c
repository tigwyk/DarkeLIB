...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "minor elemental", "cold elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(10);
  set_overall_ac(10);
  set_short("minor cold elemental");
  set_long("This minor elemental glows with the energy of cold");
  set_aggr_status(0);

	set_melee_damage( (["cold" : 10 ]) );
