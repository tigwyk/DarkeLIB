...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "minor elemental", "electricity elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(10);
  set_overall_ac(10);
  set_short("minor electricity elemental");
  set_long("This minor elemental glows with the energy of electricity");
  set_aggr_status(0);

	set_melee_damage( ([ "electricity" : 10, "fire" : 10, "impact"  : 10 ]) );
  ...
  set_skill("electricity lore", 100);
  set_max_mp(250);
  set_mp(250);
