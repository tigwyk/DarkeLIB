...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", " elemental", "wind elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(15);
  set_overall_ac(15);
  set_short(" wind elemental");
  set_long("This  elemental glows with the energy of wind");
  set_aggr_status(0);

	set_melee_damage( (["vacuum" : 15, "impact" : 15 ]) );
