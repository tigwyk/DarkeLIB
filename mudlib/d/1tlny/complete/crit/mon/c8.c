...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", " elemental", "electricity elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(15);
  set_overall_ac(15);
  set_short(" electricity elemental");
  set_long("This  elemental glows with the energy of electricity");
  set_aggr_status(0);

	set_melee_damage( (["electricity" : 15, "impact" : 15, "fire" : 15 ]) );
  ...
  set_skill("electricity lore", 125);
  set_max_mp(500);
  set_mp(500);
