...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", " greater elemental", "plasma elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(20);
  set_overall_ac(20);
  set_short(" greater plasma elemental");
  set_long("This greater elemental glows with the energy of plasma");
  set_aggr_status(0);

	set_melee_damage( (["plasma" : 20 , "fire" : 20, "electricity" : 20 ]) );
