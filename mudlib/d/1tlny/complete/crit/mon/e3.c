...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "elemental dragon", "earth elemental", "dragon" }));
  set("race", "elemental");
  ...
  set_level(25);
  set_overall_ac(25);
  set_short("earth elemental dragon");
  set_long("This elemental dragon glows with the energy of earth");
  set_aggr_status(0);

	set_melee_damage( (["impact" : 25, "crushing" : 25 ]) );
