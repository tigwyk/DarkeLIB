...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "elemental dragon", "inertia elemental", "dragon" }));
  set("race", "elemental");
  ...
  set_level(25);
  set_overall_ac(25);
  set_short("inertia elemental dragon");
  set_long("This elemental dragon glows with the energy of inertia");
  set_aggr_status(0);

	set_melee_damage( (["crushing" : 25, "stress" : 25, "impact" : 25 ]) );
