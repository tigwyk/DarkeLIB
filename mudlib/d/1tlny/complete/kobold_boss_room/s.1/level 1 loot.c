...
switch(random(14)){
   ...
   set_name("dragon");
   set("id", ({ "dragon", "Dragon", "red dragon" }));
   set("long",
   ...
   set_short("["+zlevel+"]small%^RED%^Red%^RESET%^Dragon");
  ...
  // set_exp(6432454);
   ...
   set_stats("strength", 100 + zlevel);
   set_stats("dexterity", 100 + zlevel);
   set_stats("constitution", 100 + zlevel);
   set_stats("wisdom", 50 + zlevel);
   set_stats("intelligence", 50 + zlevel);
   set_stats("charisma", 50 + zlevel);
/*    
