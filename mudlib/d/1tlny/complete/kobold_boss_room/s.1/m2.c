...
switch(random(7)){
  ...
  set("chase",1);
   ...
   set_stats("strength", 80 + random(30));
   set_stats("dexterity", 80 + random(30));
   set_stats("constitution", 80 + random(20));
   set_stats("wisdom", 30 + random(20));
   set_stats("intelligence", 30 + random(20));
   ...
   set_skill("dodge", 60);
   set_skill("reverse stroke", 60);
   set_skill("martial arts",60);
