...
void story_telling() {
	...
	string story;
	switch(random(4)) {
case 0: story = "\nAn old and scarred weretiger approaches the "

"guillotine and stares up at the razor sharp blade.  "
"As if haunted by a painfull memory he cringes and lets "
"out a long and deep sigh.  Wiping a tear from his cheek he moves "
"on down the road.\n";
			break;
