...
EndText
    ...
    add_item("painting","It seems to be a storm-giant wrestling a mammoth. WOW!");
    add_item("bed","A huge bed, bigger than any you have ever seen before.");
    add_item("beds","Three huge beds, they are bigger than any beds you have ever seen before!");
