...
them. Obviously some kind of military training. To the 
north you see a cage.
EndText
);  
    set( "night long", @EndText
Your feet sink deeply into the mud that covers the ground.
This area seems empty at this hour. To the north you see a
cage.
EndText
);   
    ...
    set_smell("default", "Dust fill your lungs, making it hard to breathe.");   
     
    set_exits( ({
ROOMS_PATH+"cage",ROOMS_PATH+"camp5",ROOMS_PATH+"camp3" }), ({
"north", "east", "south" }) );
}
