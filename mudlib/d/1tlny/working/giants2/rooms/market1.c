...
directions, surrounding the marketplace. To the west you see 
citizens entering and leaving some kind of store.
EndText
);
...
marketplace. To the west you see what appears to be a store although
it seems closed at this hour.
EndText
); 
...
set_exits( ({ ROOMS_PATH+"store1", ROOMS_PATH+"road7",
ROOMS_PATH+"market6" }), ({ "west", "east",
"north" }) );     
}
