...
surrounding you and a marvellous fountain can be seen to the east.
...
marvellous fountain can be seen to the east. The marketplace seems
...
set_exits( ({ ROOMS_PATH+"fountain", ROOMS_PATH+"market11",
ROOMS_PATH+"market7", ROOMS_PATH+"market17" }), ({ "east", "west", "south",
"north" }) );     
}   
