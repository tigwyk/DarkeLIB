...
surrounding you and a marvellous fountain can be seen to the west.
...
marvellous fountain can be seen to the west. The marketplace seems
...
set_exits( ({ ROOMS_PATH+"market15", ROOMS_PATH+"fountain",
ROOMS_PATH+"market9", ROOMS_PATH+"market19" }), ({ "east", "west", "south",
"north" }) );     
}   
