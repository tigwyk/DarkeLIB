...
surrounding you and a marvellous fountain can be seen to the southeast.
...
marvellous fountain can be seen to the southeast. The marketplace seems
...
set_exits( ({ ROOMS_PATH+"market18", ROOMS_PATH+"market16",
ROOMS_PATH+"market12", ROOMS_PATH+"market22" }), ({ "east", "west", "south",
"north" }) );     
}   
