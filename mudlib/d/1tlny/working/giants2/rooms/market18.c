...
surrounding you and a marvellous fountain can be seen to the south.
...
marvellous fountain can be seen to the south. The marketplace seems
...
set_exits( ({ ROOMS_PATH+"market19", ROOMS_PATH+"market17",
ROOMS_PATH+"fountain", ROOMS_PATH+"market23" }), ({ "east", "west", "south",
"north" }) );     
}   
