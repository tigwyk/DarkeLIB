...
surrounding you and a marvellous fountain can be seen to the southwest.
...
marvellous fountain can be seen to the southwest. The marketplace seems
...
set_exits( ({ ROOMS_PATH+"market20", ROOMS_PATH+"market18",
ROOMS_PATH+"market14", ROOMS_PATH+"market24" }), ({ "east", "west", "south",
"north" }) );     
}   
