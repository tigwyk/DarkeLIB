...
directions, surrounding the marketplace. To the east is a road 
leading into a quarry.
EndText
); 
...
marketplace. To the east is a road leading into the quarry.
EndText
); 
...
set_exits( ({ ROOMS_PATH+"market19", ROOMS_PATH+"quarry_entrance",
ROOMS_PATH+"market15", ROOMS_PATH+"market25" }), ({ "west", "east", "south",
"north" }) );
}
