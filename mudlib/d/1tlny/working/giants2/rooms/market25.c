...
directions, surrounding the marketplace. The walls directly to the 
north and east of you tells you this is the northeast corner of 
the marketplace.
EndText
); 
...
marketplace. The walls directly to the north and east of you tells
you this is the norteast corner of the marketplace.
...
set_exits( ({ ROOMS_PATH+"market24", ROOMS_PATH+"market20" }),
({ "west", "south" }) );
}
