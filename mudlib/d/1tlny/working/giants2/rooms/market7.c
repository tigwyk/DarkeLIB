...
surrounding you and a marvellous fountain can be seen to the northeast.
...
marvellous fountain can be seen to the northeast. The marketplace seems
...
set_exits( ({ ROOMS_PATH+"market8", ROOMS_PATH+"market6",
ROOMS_PATH+"road7",
ROOMS_PATH+"market12" }), ({ "east", "west", "south",
"north" }) );     
}
