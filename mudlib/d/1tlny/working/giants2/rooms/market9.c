...
surrounding you and a marvellous fountain can be seen to the northwest.
...
marvellous fountain can be seen to the northwest. The marketplace seems
...
set_exits( ({ ROOMS_PATH+"market10", ROOMS_PATH+"market8",
ROOMS_PATH+"market4", ROOMS_PATH+"market14" }), ({ "east", "west", "south",
"north" }) );     
}   
