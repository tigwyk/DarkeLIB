...
directions, surrounding the marketplace. There is a road to the south.
EndText
);
...
marketplace. A road leading out of the village is to the south.
EndText
); 
...
area and in the middle of all a fountain can be seen.");
    add_item("fountain","Shaped of solid rock you realize that the craftsmanship of this fountain is astonishing.");
     set_exits( ({ ROOMS_PATH+"market1", ROOMS_PATH+"market3",
ROOMS_PATH+"market7", ROOMS_PATH+"road6" }), ({ "west", "east",
"north", "south" }) );
}
