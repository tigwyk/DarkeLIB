...
#include <std.h>
  ...
  string rand_short;
    ...
    set("long","A female gobo that is going about taking care of the"
               " little gobo's and males that need attention.");
    set("race","goblin");
    set_gender("female");
    set_body_type("human");
    set_overall_ac(6);
    ...
    set_speech(5, "goblinish", ({"Don't hurt me please..",
                                  "I'll do anything you want.. ",
                                   "Can I get anything for you?",}), 0);
