...
void create() {
	...
	::create();
	seteuid(geteuid());
       set_name("Guardian of The Sword");
	set("id", ({"guardian", "centaur", "centaur guardian" }) );
	set_level(15 + random(5));
	this_object()->set("short", "Guardian of the Sword");
	set("long",
	...
	set_skill("two handed polearm", LEV * 4);
         set_skill("concentrate", LEV * 4);
         set_skill("earth lore", LEV * 4);
         set_skill("elementalism", LEV * 4);
