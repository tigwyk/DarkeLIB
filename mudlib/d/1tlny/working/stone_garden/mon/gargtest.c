...
{
object statue;
  tell_room(environment(this_object()), "Im turning to tone now!\n");
//code here to make the statue
//  statue = new(MON_PATH + "statue_item");
//  statue -> move(environment(this_object()));
  remove();
  return;
}
