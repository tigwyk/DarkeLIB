...
lively area.  To the east is a small fountain, a bit farther then that
are more benches.
DAY
);
...
popular during the day.  Some plants liven the small area.  To the west
somewhere are some torches.  You can hear a fountain to the east.
NIGHT
);
   ...
   set_listen("default","You hear a fountain to the east.");
   set_smell("default","The air smells fresh and clean.");
   add_exit(TARAROOMS+"rm10", "east");
}
