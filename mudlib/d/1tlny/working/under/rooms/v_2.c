...
void create() {
	...
	set_items(([
	"moss" : "The moss on the floor seems to glow brightly to the east.",
	"east" : "There looks like there is an exit to the east!",
	...
	add_exit("/wizards/blial/under/rooms/w_2", "east");
	add_invis_exit("east");
}
