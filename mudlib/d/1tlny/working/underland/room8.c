...
void create() {
  ::create();
    ...
    add_exit("/wizards/tobias/areas/underland/cave1", "west");
    add_exit("/wizards/tobias/areas/underland/room4", "east");
    add_exit("/wizards/tobias/areas/underland/room9", "north");
