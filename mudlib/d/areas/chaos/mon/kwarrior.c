...
int zlevel,xskill,roll,xchange,xname;
	...
	case 4:zlevel=33;break;
	case 5:zlevel=33;break;
	case 6:zlevel=33;break;
	case 7:zlevel=34;break;
	case 8:zlevel=35;break;
	case 9:zlevel=36;break;
}
	set("race", "human");
	xname=random(10);
	switch(xname) {
	case 0:xname="["+zlevel+"]Fearsome Khorne warrior";break;
	case 1:xname="["+zlevel+"]Ferocious Khorne warrior";break;
	case 2:xname="["+zlevel+"]Bloodthirsty Khorne warrior";break;
	case 3:xname="["+zlevel+"]Feral Khorne warrior";break;
	case 4:xname="["+zlevel+"]Bull-headed Khorne warrior";break;
	case 5:xname="["+zlevel+"]Overbearing Khorne warrior";break;
	case 6:xname="["+zlevel+"]Powerful Khorne warrior";break;
	case 7:xname="["+zlevel+"]Beast-like Khorne warrior";break;

	case 8:xname="["+zlevel+"]Cannibalistic Khorne warrior";break;
	case 9:xname="["+zlevel+"]Skull headed Khorne warrior";break;
}
	set_short(xname);
