...
int zlevel,xskill,roll,xchange,xname;
	...
	xname=random(10);
	switch(xname) {
	case 0:xname="["+zlevel+"]Feotid Nurgle warrior";break;
	case 1:xname="["+zlevel+"]Festering Nurgle warrior";break;
	case 2:xname="["+zlevel+"]Rotting Nurgle warrior";break;
	case 3:xname="["+zlevel+"]Slimy Nurgle warrior";break;
	case 4:xname="["+zlevel+"]Fly infested Nurgle warrior";break;
	case 5:xname="["+zlevel+"]Plague ridden Nurgle warrior";break;
	case 6:xname="["+zlevel+"]Leathery skinned Nurgle warrior";break;
	case 7:xname="["+zlevel+"]Puss filled Nurgle warrior";break;

	case 8:xname="["+zlevel+"]Zombie-like Nugle warrior";break;
	case 9:xname="["+zlevel+"]Black spoltches Nurgle warrior";break;
}
	set_short(xname);
