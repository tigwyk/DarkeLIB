...
int zlevel,xskill,roll,xchange,xname;
	...
	case 7:zlevel=33;break;
	case 8:zlevel=34;break;
	case 9:zlevel=35;break;
}
	set("race", "human");
	xname=random(10);
	switch(xname) {
	case 0:xname="["+zlevel+"]Shiny armored Slaanesh warrior";break;
	case 1:xname="["+zlevel+"]Lewd long-tounged Slaanesh warrior";break;
	case 2:xname="["+zlevel+"]Single breasted hermaphrodital Slaanesh warrior";break;
	case 3:xname="["+zlevel+"]Overtly beautiful Slaanesh warrior";break;
	case 4:xname="["+zlevel+"]Claw armed Slaanesh warrior";break;
	case 5:xname="["+zlevel+"]Many flailing tentacled Slaanesh warrior";break;
	case 6:xname="["+zlevel+"]Scantily armored Slaanesh warrior";break;
	case 7:xname="["+zlevel+"]Featureless faced Slaanesh warrior";break;
	case 8:xname="["+zlevel+"]Tantalizing Slaanesh warrior";break;
	case 9:xname="["+zlevel+"]Lacey armored Slaanesh warrior";break;
}
	set_short(xname);
