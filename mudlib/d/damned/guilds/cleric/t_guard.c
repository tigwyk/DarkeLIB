...
int block_exit() {
  ...
  object join_room, *inv;
	...
	if(find_player(p_name) && find_player(p_name)->query_class() == "cleric") return 0;
	     force_me("speak common");
     force_me("say I will not allow a pet named "+TP->query_name()+" from entering as you are not a Cleric");		
		return 1;
    }
...
force_me("speak common");
     force_me("say Only clerics may pass.");
    return 1;
 }
