...
new("d/damned/guilds/join_rooms/tcan")->move(this_object());
  ...
  set("short", "The Jedi's Guild Joining Room");
  set("long", 
"This is the Jedi joining room. Here you "+
	"can join the Jedi, a secret group of deadly "+
  ...
  set_exits( ([ 
              ...
              "east" : "/d/newbieville/rooms/ngates",
  ...
  set_guild_obj("/d/damned/guilds/jedi/jedi_obj");
