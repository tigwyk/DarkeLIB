...
int do_damage(string limb, int amt) {
    ...
    message("info", "%^BOLD%^%^GREEN%^The wall of souls covering your body completely absorbs "+previous_object()->query_cap_name()+"'s attack!%^RESET%^", who_shadowed);
    message("info", "%^BOLD%^%^GREEN%^The wall of souls covering "+who_shadowed->query_cap_name()+"'s body completely absorbs your attack!%^RESET%^", previous_object());
    message("info", "%^BOLD%^%^GREEN%^The wall of souls covering "+who_shadowed->query_cap_name()+"'s body completely absorbs "+previous_object()->query_cap_name()+"'s attack!%^RESET%^", environment(who_shadowed), ({ who_shadowed, previous_object() }));
