...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "minor elemental", "earth elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(10);
  set_overall_ac(10);
  set_short("minor earth elemental");
  set_long("This minor elemental glows with the energy of earth");
  set_aggr_status(0);

	set_melee_damage( (["impact" : 10 , "crushing" : 10 ]) );
