...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "minor elemental", "wind elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(10);
  set_overall_ac(10);
  set_short("minor wind elemental");
  set_long("This minor elemental glows with the energy of wind");
  set_aggr_status(0);

	set_melee_damage( ([ "vacuum"  : 10 , "impact" : 10 ]) );
