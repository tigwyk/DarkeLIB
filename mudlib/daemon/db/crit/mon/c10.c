...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", " elemental", "plasma elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(15);
  set_overall_ac(15);
  set_short(" plasma elemental");
  set_long("This  elemental glows with the energy of plasma");
  set_aggr_status(0);

	set_melee_damage( (["plasma" : 15, "fire" : 15, "electricity" : 15 ]) );
