...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", " greater elemental", "vacid elemental" }));
  set("race", "elemental");
  set_body_type("human");
  ...
  set_level(20);
  set_overall_ac(20);
  set_short(" greater vacid elemental");
  set_long("This greater elemental glows with the energy of vacid");
  set_aggr_status(0);

	set_melee_damage( (["cold" : 20 , "stress" : 20, "impact" : 20 ]) );
