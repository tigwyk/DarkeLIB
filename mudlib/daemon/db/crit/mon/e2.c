...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "elemental dragon", "water elemental", "dragon" }));
  set("race", "elemental");
  ...
  set_level(25);
  set_overall_ac(25);
  set_short("water elemental dragon");
  set_long("This elemental dragon glows with the energy of water");
  set_aggr_status(0);

	set_melee_damage( (["impact" : 25 ]) );
