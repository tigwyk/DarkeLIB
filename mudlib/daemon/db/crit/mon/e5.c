...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "elemental dragon", "cold elemental", "dragon" }));
  set("race", "elemental");
  ...
  set_level(25);
  set_overall_ac(25);
  set_short("cold elemental dragon");
  set_long("This elemental dragon glows with the energy of cold");
  set_aggr_status(0);

	set_melee_damage( (["cold" : 25 ]) );
