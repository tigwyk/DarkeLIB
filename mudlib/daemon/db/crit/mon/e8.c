...
void create() {
  ::create();
  set_name("elemental");
  set_id(({ "elemental", "elemental dragon", "electricity elemental", "dragon" }));
  set("race", "elemental");
  ...
  set_level(25);
  set_overall_ac(25);
  set_short("electricity elemental dragon");
  set_long("This elemental dragon glows with the energy of electricity");
  set_aggr_status(0);

	set_melee_damage( (["electricity" : 25, "impact" : 25, "fire" : 25 ]) );
  ...
  set_skill("electricity lore", 175);
  set_max_mp(1500);
  set_mp(1500);
  ...
  set_spell_level("greater elemental bolt", 4);
