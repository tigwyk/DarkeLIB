...
void create() {
	...
	set("day long",@ext You continue to follow the road through the second level of 
    ...
    0
ext);
	set("night long",@ext Even at night the streets are alive with action. Jugglers 
